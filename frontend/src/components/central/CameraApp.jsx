...
import Vehicle3DTopDown from './Vehicle3DTopDown';
    ...
    <div className="camera-app">
      <div className="camera-content">
        ...
        <div className="camera-left-panel">
          ...
          <Card variant="default" className="surround-view-container">
        ...
        <div className="camera-right-panel">
          <Card variant="default" className="individual-camera-view">
